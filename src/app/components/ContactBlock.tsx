...
export function ContactBlock() {
  return (
    <section id="contact" className="border-t border-zinc-200 bg-zinc-100 px-4 py-12 text-zinc-950 dark:border-white/10 dark:bg-zinc-950 dark:text-white sm:px-6 sm:py-16">
